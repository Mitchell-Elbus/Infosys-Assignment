...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			...
			prop.load(new FileReader("C:\\Users\\User\\Documents\\Infosys-Airline-Reservation\\Infosys-Airline\\Infosys-Assignment\\Infosys-Task\\src\\main\\resources\\application.properties"));
			

			//TODO: Check that this relative path is working. 
